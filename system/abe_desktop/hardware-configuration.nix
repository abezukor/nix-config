...

{
  ...
  fileSystems."/" = {
    device = "/dev/disk/by-uuid/2319d68f-8beb-4fa0-8180-b09bbe77a6fd";
    fsType = "ext4";
  };

  fileSystems."/nix" = {
    device = "/dev/disk/by-uuid/ba86d604-2854-4af2-a61c-3804eff8bf80";
    fsType = "btrfs";
    options = [ "subvol=nix" ];
  };
  ...
  fileSystems."/boot" = {
    device = "/dev/disk/by-uuid/7B38-5B87";
    fsType = "vfat";
    options = [
      "fmask=0022"
      "dmask=0022"
